...
MediaInfo = namedtuple('Point', ['duration', 'width', 'height'])
...
def do_annotations(media_info: MediaInfo, insights: dict, src_key: str, outputs: dict, dest_key: str, thumbnail_cache: ThumbnailCache):
    """Create annotations"""
...
def do_audio_effects(media_info: MediaInfo, insights: dict, src_key: str, outputs: dict, dest_key: str, thumbnail_cache: ThumbnailCache):
...
def do_brands(media_info: MediaInfo, insights: dict, src_key: str, outputs: dict, dest_key: str, thumbnail_cache: ThumbnailCache):
    res = []
...
def do_detected_objects(media_info: MediaInfo, insights: dict, src_key: str, outputs: dict, dest_key: str, thumbnail_cache: ThumbnailCache):
    res = []
    for item in insights[src_key]:
...
def do_frame_patterns(media_info: MediaInfo, insights: dict, src_key: str, outputs: dict, dest_key: str, thumbnail_cache: ThumbnailCache):
    res = []
...
def do_labels(media_info: MediaInfo, insights: dict, src_key: str, outputs: dict, dest_key: str, thumbnail_cache: ThumbnailCache):
...
def do_named_locations(media_info: MediaInfo, insights: dict, src_key: str, outputs: dict, dest_key: str, thumbnail_cache: ThumbnailCache):
    res = []
    for item in insights[src_key]:
        for inst in item['instances']:
...
def do_ocr(media_info: MediaInfo, insights: dict, src_key: str, outputs: dict, dest_key: str, thumbnail_cache: ThumbnailCache):
    res = []
    for item in insights[src_key]:
        for inst in item['instances']:
...
def do_sentiments(media_info: MediaInfo, insights: dict, src_key: str, outputs: dict, dest_key: str, thumbnail_cache: ThumbnailCache):
    res = []
...
def do_transcript(media_info: MediaInfo, insights: dict, src_key: str, outputs: dict, dest_key: str, thumbnail_cache: ThumbnailCache):
...
def do_video_segments(media_info: MediaInfo, insights: dict, src_key: str, outputs: dict, dest_key: str, thumbnail_cache: ThumbnailCache):
    res = []
